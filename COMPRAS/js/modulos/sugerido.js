/* COMPRAS · CO-15 Sugerido de Compras — DATOS DE EJEMPLO · no conectado a la base compartida (docs/16 §5) */
/* ===== CO-15 · Sugerido de Compras ===== */
let SUG_SEQ=34;
const SUG_MESES_LBL=["Nov","Dic","Ene","Feb","Mar","Abr","May","Jun","Jul"];
const SUGERIDO=[
 {cod:"MP-0045",nom:"CIERRE METALICO 12CM",u:"UND",t:"MATERIA PRIMA",c:"AVÍOS DE CONFECCIÓN",alm:"SB-CENTRAL-MP",
 ...
 {cod:"MP-0044",nom:"BOTON METALICO 17MM",u:"UND",t:"MATERIA PRIMA",c:"AVÍOS DE ACABADOS - PRINCIPALES",alm:"SB-CENTRAL-MP",
 ...
 {cod:"MP-0046",nom:"CIERRE YKK RC-045 12CM",u:"UND",t:"MATERIA PRIMA",c:"AVÍOS DE CONFECCIÓN",alm:"SB-CENTRAL-MP",
 ...
 {cod:"MP-0012",nom:"TELA DENIM 12 OZ AZUL",u:"MT",t:"MATERIA PRIMA",c:"TELAS",alm:"SB-CENTRAL-MP",
 ...
 {cod:"MP-0013",nom:"TELA DENIM 12 OZ NEGRO",u:"MT",t:"MATERIA PRIMA",c:"TELAS",alm:"SB-CENTRAL-MP",
  meses:[340,470,360,400,420,410,380,450,430],plan:0,hol:15,disp:96.50,cam:0,camDoc:""},
 {cod:"MP-0031",nom:"HILO POLIESTER AZUL",u:"CONO",t:"MATERIA PRIMA",c:"HILOS",alm:"SB-CENTRAL-MP",
  meses:[40,55,42,46,48,47,44,52,48],plan:8,hol:15,disp:45,cam:0,camDoc:""},
 {cod:"MP-0032",nom:"HILO POLIESTER NEGRO",u:"CONO",t:"MATERIA PRIMA",c:"HILOS",alm:"SB-CENTRAL-MP",
  meses:[22,34,25,28,30,29,26,32,30],plan:0,hol:15,disp:38,cam:0,camDoc:""},
 {cod:"MERC-0205",nom:"CARTERA MINI VALENTINA COLOR CAMEL",u:"UND",t:"MERCADERÍA",c:"CARTERAS",alm:"SB-CENTRAL",
...
function sugGenerarSOL(i){
  ...
  toast("Datos de ejemplo: "+r.nom+" sugiere "+fmtQ(v,r.u)+" "+r.u+". Registre la Solicitud de Materiales real en GI-13 con artículos del maestro compartido");
  if(document.getElementById('scr-gi13'))go('gi13');
}
