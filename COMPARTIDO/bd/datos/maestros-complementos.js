...
const BD_COMPLEMENTOS = (() => {
  ...
  SERVICIOS.forEach((s, i) => {
    ...
    proveedores.push({ cod: prov, tipoDoc: s[2], doc: s[3], nom: s[1], comercial: s[1], grupo: 'Nacional', tipo: 'SRV', estado: 'Activo', email: '', dir: '', ubigeo: 'LIMA / Lima / La Victoria', tel: '', cel: '',
