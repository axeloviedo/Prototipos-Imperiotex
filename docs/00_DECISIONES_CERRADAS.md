...
| P3 | **Factura impaga o pagada** | Impaga: la nota **rebaja lo que se debe** (si llega a cero, la factura queda Pagada). Pagada: la nota queda como **saldo a favor** del proveedor, para descontarlo en el próximo pago (Tesorería). |
