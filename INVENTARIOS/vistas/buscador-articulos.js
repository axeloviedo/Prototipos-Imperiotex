  ...
  <div class="modal lg">
    ...
    <div class="modal-b">
      <div style="display:inline-flex;align-items:center;gap:8px;background:#EEF2F7;border:1px solid var(--borde);border-radius:14px;padding:5px 13px;font-size:12px;margin-bottom:12px">
        <span class="dot" style="background:var(--primario-claro)"></span><b>Disponible en:</b> <span id="ct03-chip">-</span>
      </div>
      ...
      <table class="grid subtable">
        <thead><tr><th>Código</th><th>Nombre</th><th>Unidad</th><th>Control</th><th style="text-align:right" id="ct03-colstock">Disponible</th><th style="width:90px"></th></tr></thead>
        <tbody id="ct03-body"></tbody>
      </table>
      <p class="hint" style="margin-top:10px">Artículos activos del maestro de la base (solo inventariables cuando el documento mueve stock). Talla y color son atributos del artículo. El disponible (Actual − Comprometido) corresponde al almacén del documento que abrió el buscador.</p>
    </div>
