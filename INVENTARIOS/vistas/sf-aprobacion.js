/* INVENTARIOS · GI-23 Solicitudes de materiales generadas, V°B° y decisiones con trazabilidad — HTML */
...
<div class="overlay" id="m-gi23d">
  <div class="modal">
    <div class="modal-h"><b>Solicitar modificación a Comercial</b><span class="code" style="font-size:11px;color:var(--texto-sec)">GI-23d</span><span class="x" onclick="closeModal('m-gi23d')">✕</span></div>
    <div class="modal-b">
    ...
    <div class="modal-f"><button class="btn btn-secondary" onclick="closeModal('m-gi23d')">Volver</button><button class="btn btn-primary" onclick="devolverSP()">Devolver a Comercial</button></div>
  </div>
</div>
`);
