...
- **SF-000002** (PT-0003 × 30, PT-0004 × 24): **en curso**. Crudo T30 con 16 de 24 recibidos; lavado T28 devuelto por la lavandería con 26 de 30 prendas y cerrado: el faltante de 4 lo reclama Compras (CO-11) y se cierra con una nota de crédito 09; lavado T30 con el servicio pedido (SOL pendiente en Logística).
